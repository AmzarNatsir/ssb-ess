<div class="modal-header bg-primary text-white border-0">
    <h5 class="modal-title fw-bold" id="exampleModalCenteredScrollableTitle">
        <i class="ti ti-file-check me-2"></i>Form Persetujuan Pengajuan Cuti
    </h5>
                ...
                <div class="card-body">
                    ...
                    <table class="table table-sm table-borderless mb-0">
                        ...
                        <tr>
                            ...
                            <td class="fw-semibold">{{ $profil->ket_cuti }}</td>
                        </tr>
                        <tr>
                            <td class="text-muted">Rencana Cuti</td>
                        ...
                        @if($data_approval->approval_level > 1)
                        <tr>
                            <td class="text-muted">Karyawan Pengganti</td>
                            <td class="fw-semibold">{{ (empty($profil->id_pengganti)) ? "-" : ($profil->get_karyawan_pengganti->nm_lengkap ?? '-') }}</td>
                        </tr>
                        @endif
                    </table>
                </div>
