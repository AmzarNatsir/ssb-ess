<div class="modal-header bg-primary text-white border-0">
    <h5 class="modal-title fw-bold" id="exampleModalCenteredScrollableTitle">
        <i class="ti ti-file-check me-2"></i>Form Persetujuan Pengajuan Izin
    </h5>
    ...
    <div class="row g-3 mb-3">
        <div class="col-md-6">
            <div class="card bg-light border-0 h-100">
                <div class="card-body">
                    @php
                        $karyawanProfil = $profil->profil_karyawan ?? $profil->karyawan;
                    @endphp
                    ...
                    <table class="table table-sm table-borderless mb-0">
                        <tr>
                            ...
                            <td class="fw-semibold">{{ $karyawanProfil?->nik ?? '-' }}</td>
                        </tr>
                        <tr>
                            <td class="text-muted">Nama Karyawan</td>
                            <td class="fw-semibold">{{ $karyawanProfil?->nm_lengkap ?? '-' }}</td>
                        </tr>
                        <tr>
                            <td class="text-muted">Jabatan</td>
                            <td class="fw-semibold">{{ $karyawanProfil?->get_jabatan?->nm_jabatan ?? '-' }}</td>
                        </tr>
                    </table>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <table class="table table-sm table-borderless mb-0">
                        ...
                        <tr>
                            ...
                            <td class="fw-semibold">{{ $profil->ket_izin }}</td>
                        </tr>
                        <tr>
                            <td class="text-muted">Rencana Izin</td>
                            <td class="fw-semibold">{{ date_format(date_create($profil->tgl_awal), 'd-m-Y') }} s/d {{ date_format(date_create($profil->tgl_akhir), 'd-m-Y') }}</td>
                        </tr>
                        <tr>
                            <td class="text-muted">Jumlah Hari</td>
                            <td class="fw-semibold text-primary">{{ $profil->jumlah_hari }} hari</td>
                        </tr>
                    </table>
                </div>
            </div>
