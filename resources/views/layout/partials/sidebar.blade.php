                ...
                <li>
                    <ul>
                        ...
                        <li class="{{ Request::is('leave') ? 'active' : '' }}">
                            <a href="{{ route('leave.index') }}"><i
                                    class="ti ti-building-community"></i><span>Leave</span></a>
                        </li>
                        <li class="{{ Request::is('permission') ? 'active' : '' }}">
                            <a href="{{ route('permission.index') }}"><i
                                    class="ti ti-medal"></i><span>Permission</span></a>
                        </li>
                        <li class="{{ Request::is('overtime', 'overtime/*') ? 'active' : '' }}">
                            <a href="{{ route('overtime.index') }}"><i
                                    class="ti ti-clock-share"></i><span>Overtime</span></a>
                        </li>
                        <li class="{{ Request::is('attendence*') ? 'active' : '' }}">
                            <a href="{{ route('attendence.index') }}"><i
                                    class="ti ti-calendar-check"></i><span>Attendance</span></a>
                        </li>
                        <li class="{{ Request::is('perdis*') ? 'active' : '' }}">
                            <a href="{{ route('perdis.index') }}"><i
                                    class="ti ti-brand-campaignmonitor"></i><span>Official travel</span></a>
                        </li>
                        <li class="{{ Request::is('memorandum*') ? 'active' : '' }}">
                            <a href="{{ route('memorandum.index') }}"><i
                                    class="ti ti-atom-2"></i><span>Memorandum</span></a>
                        </li>
                        <li class="{{ Request::is('training*') ? 'active' : '' }}">
                            <a href="{{ route('training.index') }}"><i
                                    class="ti ti-list-check"></i><span>Training</span></a>
                        </li>
                        <li class="{{ Request::is('pinjaman', 'pinjaman/*') ? 'active' : '' }}">
                            <a href="{{ route('pinjaman.index') }}"><i class="ti ti-file-dollar"></i><span>Employee
                                    Loans</span></a>
                        </li>
